...
python3 scripts/extract_results_to_webapp.py \
  ...
  --output webapp-amchi/public/data/deaf_speech_results_dsd.json
```
...
**Webapp**: `webapp-amchi/src/app/deaf-speech/page.tsx`  
**Config**: `webapp-amchi/src/lib/deaf-speech-experiments.ts`
